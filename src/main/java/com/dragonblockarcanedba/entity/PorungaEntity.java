...
public class PorungaEntity extends Mob {
    private int wishesRemaining = 3;

    public PorungaEntity(EntityType<? extends Mob> entityType, Level level) {
    ...
    public void grantWish(ServerPlayer player, String wishType) {
        if (this.isRemoved() || this.wishesRemaining <= 0) return;
        ...
        switch (wishType) {
            case "wealth" -> {
                ...
                player.sendSystemMessage(net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7aYour wish for wealth has been granted."));
            }
            case "power" -> {
                accessor.dba$setStatPoints(accessor.dba$getStatPoints() + 150);
                accessor.dba$syncStats();
                player.sendSystemMessage(net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7aYour wish for power has been granted."));
            }
            case "immortality" -> {
                ...
                player.sendSystemMessage(net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7aYour wish for immortality has been granted."));
            }
            default -> {
                player.sendSystemMessage(net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7cThat wish is beyond my power."));
                return;
            }
        }
        ...
        if (this.level() instanceof net.minecraft.server.level.ServerLevel serverLevel) {
            ...
            // Audio cues for wish fulfillment
            ...
            if (this.wishesRemaining <= 0) {
                ...
                serverLevel.getServer().getPlayerList().broadcastSystemMessage(
                    net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7eFarewell!"), false
                );
                this.discard();
            } else {
                serverLevel.playSound(null, this.getX(), this.getY(), this.getZ(),
                ...
                serverLevel.getServer().getPlayerList().broadcastSystemMessage(
                    net.minecraft.network.chat.Component.literal("\u00a76Porunga: \u00a7eI shall grant " + this.wishesRemaining + " more wish(es)."), false
                );
            }
        }
    }
