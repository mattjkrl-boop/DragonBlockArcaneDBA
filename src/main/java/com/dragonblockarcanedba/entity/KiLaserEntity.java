...
public class KiLaserEntity extends Projectile implements GeoEntity {
    ...
    private static final net.minecraft.network.syncher.EntityDataAccessor<Integer> COLOR =
            SynchedEntityData.defineId(KiLaserEntity.class, net.minecraft.network.syncher.EntityDataSerializers.INT);
    private static final net.minecraft.network.syncher.EntityDataAccessor<Float> LENGTH =
            SynchedEntityData.defineId(KiLaserEntity.class, net.minecraft.network.syncher.EntityDataSerializers.FLOAT);
